...
import subprocess
import platform
from model_sess6072 import TAM
from math_sess6072 import l2m
from model_sess6072 import TAM, Vehicle2D_e, dynamics_translation_e, dynamics_rotation_e
from math_sess6072 import l2m, HomogeneousTransformation, Vector
from model_sess6072 import rigid_body_kinematics
from math_sess6072 import Inverse, Vector
...
# motion model
    ...
    def loop(self):
        ...
        if self.sensed_imu_stamp_s is not None or self.OPERATING_MODE == 2:  
            ...
            self.right_rate = 20.0 #rad/s
            self.left_rate = 20.0 #rad/s
